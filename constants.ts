...
export const JOB_HARVESTING_OPARL = 'http://lblod.data.gift/id/jobs/concept/JobOperation/harvesting/oparl';
...
export const HARVEST_COLLECTION_URI_PREFIX = 'http://lblod.data.gift/id/harvest-collections/';
export const REMOTE_DATA_OBJECT_URI_PREFIX = 'http://lblod.data.gift/id/remote-data-objects/';
